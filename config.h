...
/* Define to 1 if you have the <gpiod.h> header file. */
#define HAVE_GPIOD_H 1
...
/* Define to 1 if you have the `gpiod' library (-lgpiod). */
#define HAVE_LIBGPIOD 1
...
/* various directories */
#define PACKAGE_SOURCE_DIR "/home/m8/soundmodem-0.20"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "soundmodem 0.20"
